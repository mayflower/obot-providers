module github.com/obot-platform/providers/github-auth-provider
...
require (
	...
	github.com/obot-platform/providers/auth-providers-common v0.0.0-20241008222508-3c6174b443e7
)
